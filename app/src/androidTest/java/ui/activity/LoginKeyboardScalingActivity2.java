...
public class LoginKeyboardScalingActivity2 extends FragmentActivity implements View.OnClickListener {
        ...
        et_password.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (!s.toString().matches("[A-Za-z0-9]+")) {
                    ...
                    Toast.makeText(LoginKeyboardScalingActivity2.this, R.string.please_input_limit_pwd, Toast.LENGTH_SHORT).show();
