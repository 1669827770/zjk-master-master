...
/**
 *
 linglongxin24/AnimatorDemo       https://github.com/linglongxin24/AnimatorDemo
...
public class TweenedAnimationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tweenedanimation);
        ...
        switch (v.getId()) {
            case R.id.animation_alpha://透明度渐变动画
                if (fromXml) {
                     ...
                     *第二个参数toAlpha为 动画结束时候透明度    0表示完全透明,1表示完全不透明
                     */
            ...
            case R.id.animation_scale://缩放动画
                if (fromXml) {
                     ...
                     * 说明: 0.0表示收缩到没有;1.0表示正常无伸缩;值小于1.0表示收缩;值大于1.0表示放大，。起始的X方向上相对自身的缩放比例，浮点值，比如1.0代表自身无变化，0.5代表起始时缩小一倍，2.0代表放大一倍
            ...
            case R.id.animation_activity://activity跳转动画
                ...
                break;
            case R.id.animation_video_play://录制视频闪闪，停止变灰
              if(START_OR==1){
                  img_state.setImageResource(R.drawable.videotapeopen);
                  alphaAnimation1 = new AlphaAnimation(1, 0);
                  alphaAnimation1.setDuration(1000);
                  alphaAnimation1.setRepeatCount(Animation.INFINITE);
                  alphaAnimation1.setRepeatMode(Animation.REVERSE);
                  img_state.startAnimation(alphaAnimation1);
                  START_OR=2;
              }else {
                  if(alphaAnimation1!=null){
                      img_state.clearAnimation();
                  }
                  img_state.setImageResource(R.drawable.videotape);
