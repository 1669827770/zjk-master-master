...
import ui.fragment.AudioListFragmentPhone;
import ui.fragment.VideoListFragmentPhone;
import videodemo.R;

public class MainActivityPhone extends PhoneBaseActivity {
    ...
    public int getLayoutID() {
        return R.layout.activity_mainphone;
    }
    ...
    public void initData() {
        fragmentList.add(new VideoListFragmentPhone());
        fragmentList.add(new AudioListFragmentPhone());
