...
public class VideoAudioActivity extends Activity {
    ...
    public  TextView createRandomColorShapeSelectorTextView(Context context) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(text.equals("视频裁剪")){
                    startActivity(new Intent(getApplicationContext(), VideoClippingActivity.class));
                }else if (text.equals("88视频播放器")){
                    startActivity(new Intent(getApplicationContext(), MobilePlayerActivity.class));
                }else if (text.equals("状态栏图标")){
                    startActivity(new Intent(getApplicationContext(), StatusbariconActivity.class));
                }else if (text.equals("88音频")){
