...
public class FromBottomToTopDialog extends Dialog {
    ...
    public FromBottomToTopDialog(Context context) {

        super(context, R.style.AddrDialogStyleTop);
    ...
    public FromBottomToTopDialog(Context context, int style) {
